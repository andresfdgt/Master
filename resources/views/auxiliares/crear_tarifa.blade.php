...
@section('contenido')
    <div class="container-fluid">
        ...
        <div class="card">
            <div class="card-body">
                <form class="needs-validation" enctype="multipart/form-data" novalidate id="nuevaTarifa" method="post">
                    @csrf
                    <div class="form-row">
                    ...
                    <div class="form-row">
                        <div class="col-md-3 mb-3">
                            ...
                            <select name="tipo" id="tipo_tarifa" class="form-control" required>
                                <option value="%dcto" selected>Descuento</option>
                                <option value="importe">Importe</option>
                                <option value="%incr">Incremento</option>
                            </select>
                        </div>
                    </div>
                    <div class="form-row">
                        <div class="col-md-3 mb-3">
                            ...
                            <input type="number" step="0.001" id="valor" name="valor"
                        ...
                        <div class="col-md-6 mb-3">
                            <div class="checkbox my-2">
                                <div class="custom-control custom-checkbox">
                                    <input type="checkbox" class="custom-control-input" id="ivaincluido" name="ivaincluido"
                                        value="1">
                    ...
                    <div class="form-row">
                        <div class="col-md-12 text-center">
                            <button class="btn btn-primary" id="registrarTarifa" type="submit">Crear tarifa</button>
                        </div>
                    </div>
                </form>
            </div>
...
@section('add-scripts')
    ...
    <script>
        ...
        $("#nuevaTarifa").submit(function(e) {
            e.preventDefault();
            $('#nuevaTarifa').addClass('was-validated');
            if ($('#nuevaTarifa')[0].checkValidity() === false) {
                ...
                $.ajax({
                    type: "post",
                    url: "/tarifas",
                    data: new FormData($('#nuevaTarifa')[0]),
                    contentType: false,
                    cache: false,
                    processData: false,
                    beforeSend: function() {
                        $("#registrarTarifa").html(
                            "<i class='fa fa-spinner fa-pulse'></i><span class='sr-only'> Registrando...</span>Registrando..."
                        );
                        $("#registrarTarifa").attr("disabled", true);
                    },
                    dataType: "json",
                    success: function(data) {
                        ...
                        if (data.status == "success") {
                            $('#nuevaTarifa').removeClass('was-validated');
