                    ...
                    <div class="card-body">
                        @if (auth()->user()->existPermission(10252))
                            <div class="form-group">
                                <a href="marcas/crear"><button type="button"
                                        class="btn btn-primary waves-effect waves-light" _msthash="2770885"
                                        _msttexthash="118105" data-toggle="modal"
                                        data-target="#modalRegistrarMarca">Nueva marca</button></a>
                            </div>
                        @endif
                        <table id="datatableMarcas" class="table table-bordered dt-responsive nowrap table-sm"
