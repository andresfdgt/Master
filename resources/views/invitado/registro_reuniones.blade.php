                        ...
                        <div class="card-body">
                            <div class="px-3">
                                ...
                                <div class="text-center auth-logo-text">
                                    ...
                                    <h5>Reunión de la iglesia {{ $iglesia->nombre }}</h5>
                                    <p class="text-muted mb-0">Registro de la reunión <b>{{ $reunion }}</b>.</p>
                                </div>
                                <!--end auth-logo-text-->
                                <form class="form-horizontal auth-form my-4 needs-validation" novalidate id="formRegistro" method="POST">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group mb-3">
                                            ...
                                            <input type="hidden" name="a" value="{{ $reunion_id }}">
                                    ...
                                    <div class="form-group mb-0 row">
                                        <div class="col-12 mt-2">
                                            <button
                                                ...
                                                type="submit" id="registrar">Confirma asistencia<i
        ...
        $("#formRegistro").submit(function(e) {
            ...
            if ($('#formRegistro')[0].checkValidity() === false) {
                ...
                $.ajax({
                    ...
                    beforeSend: function() {
                        $("#registrar").html(
                            "<i class='fa fa-spinner fa-pulse'></i><span class='sr-only'> Confirmando...</span>Confirmando ..."
                        );
                        $("#registrar").attr("disabled", true);
                    },
                    dataType: "json",
                    success: function(data) {
                        $("#registrar").html("Confirma asistencia");
