                        ...
                        <div class="card-body">
                            <div class="px-3">
                                ...
                                <div class="text-center auth-logo-text">
                                    ...
                                    <p class="text-muted mb-0">Confirmar asistencia para la reunión de celula
                                        <b>{{ $asistencia }}</b>.</p>
                                </div>
                                <!--end auth-logo-text-->
                                <form class="form-horizontal auth-form my-4 needs-validation" novalidate id="formAsistencia" method="POST">
                                    ...
                                    <div class="form-group">
                                        <label for="username">Digita tu cédula para confirmar la asistencia</label>
